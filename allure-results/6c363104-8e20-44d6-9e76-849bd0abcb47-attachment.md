...
- Name: example test
- Location: C:\Demo_project_git\myplyprj\tests\example.spec.ts:3:5
...
Call log:
  - navigating to "https://automationexercise.com/baseURL", waiting until "load"

    at C:\Demo_project_git\myplyprj\tests\example.spec.ts:4:14
```
